...
preprocess_for_tagpro <- function(
  ...
  # Return processed data with informational output
  result_list <- list(
  ...
  cat("  Number of tags:", nrow(tags_tagpro), "\n")
  cat("  Number of events:", nrow(events_tagpro), "\n")
  cat("  Number of nodes:", nrow(nodes_tagpro), "\n")
